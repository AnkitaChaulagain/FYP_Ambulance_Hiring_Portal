            ...
            <div class="container">
                <form class="cmxform form-horizontal" method="post" action="" name="search">
                    ...
                    <div class="form-group ">
                        <label for="username" class="control-label col-lg-12"
                            style="font-weight: bolder;padding-bottom: 10px;">Search by Request Number / Patient Name /
...
?>
                 ...
                 if($pstatus==""){ ?>
                            ...
                            <td><a href="booking-details.php?id=<?php echo $row['ID'];?>&&bookingnum=<?php echo $row['BookingNumber'];?>"
