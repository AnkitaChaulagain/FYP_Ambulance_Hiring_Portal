<?php
session_start(); //Starts a session to store user data temporarily.
//error_reporting(0);
include('includes/dbconnection.php'); //Connects project to the database.
if(isset($_POST['submit'])) { //form handling when user submits the booking form
    
    $bookingnum = mt_rand(100000000, 999999999); //checks if the form is submitted using the Submit button.
    ...
    $query = mysqli_query($con, "INSERT INTO tblambulancehiring (BookingNumber, PatientName, RelativeName, RelativeConNum, HiringDate, HiringTime, AmbulanceType, Address, City, Symptoms, Message) VALUES ('$bookingnum', '$pname', '$rname', '$phone', '$hdate', '$htime', '$ambulancetype', '$address', '$city', '$symptoms', '$message')");

    //inserts the collected values into the tblambulancehiring table in the database
    if ($query) {
...
<!-- This part includes the title, CSS links, Google Fonts, and styles from the Bootstrap theme called medicio-->
<head>
  ...
  * Updated: April 01 2025 with Bootstrap v5.3.2
...
<!-- Includes the navigation header -->
    <?php include_once('includes/header.php');?>

    <!-- ======= Hero Section ======= -->
     <!-- shows carousel slides with background images -->
    <section id="hero">
    ...
    <main id="main">
        ...
        <!-- ======= Featured Services Section ======= -->
         <!-- === Shows icons with Life Support, Medical Support, Emergency Kit, NICU Support === -->
        ...
        <!-- ======= Cta Section ======= -->
         <!-- === Encourages users in emergency to quickly go and hire an ambulance === -->
        ...
        <!-- ======= About Us Section ======= -->
         <!-- === Fetches About Us content from database (tblpage table) === -->
...
?>
        ...
        <!-- ======= Appointment Section ======= -->
         <!-- === When submitted, data is sent via POST and inserted into the database === -->
        <section id="appointment" class="appointment section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <form action="" method="post" role="form" class="form-control" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="text-center" style="padding-top: 20px;padding-bottom: 20px;"><button type="submit"
        ...
        <!-- ======= Contact Section ======= -->
         <!-- === Displays address, email, and phone fetched from the database (tblpage) === -->
        <section id="contact" class="contact">
            <div class="container">
                ...
                <div class="section-title">
                    ...
                    You can contact us through any of the details below.</p>
                </div>
 ...
 ?>
    ...
    <!-- includes footer design and contact info. -->
    <?php include_once('includes/footer.php');?>

    <!-- Vendor JS Files -->
     <!-- Includes required JavaScript for the template -->
