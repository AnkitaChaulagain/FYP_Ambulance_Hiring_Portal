<?php
// Starts a session, useful if you're tracking user login or other session-specific info.
session_start();
//error_reporting(0);
...
<head>
    ...
    <!-- all the CSS files are included for Bootstrap, icons, animation, and your custom style.css. -->
    <!-- Vendor CSS Files -->
        ...
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <!-- just shows the page title and breadcrumb navigation. -->
...
?>
                <table border="1" class="table table-bordered mg-b-0">
                    ...
                    <!-- shows that data inside a table: -->
                    <tr>
                        <th>Patient Name</th>
    ...
    $ambulanceTypeText = "";
    // switch case for ambulance type
    switch ($atype) {
        case "1":
    ...
    ?>
                    ...
                    <!-- Display other request details -->
                     <!-- If admin has added a status or remark -->
...
?>
                ...
                <?php 
                // users can see how their ambulance request has progressed over time
...
?>
    ...
    <!-- footer section for a consistent layout -->
    <?php include_once('includes/footer.php');?>

    <!-- Vendor JS Files -->
     <!-- Scripts for Bootstrap, animations (AOS), swiper, lightbox, etc. -->
