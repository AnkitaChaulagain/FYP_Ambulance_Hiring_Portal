...
<!DOCTYPE html>
<head>
<title>EAHP || Driver Pickup Requests</title>
 ...
 <div class="panel panel-default">
    ...
    <div>
      <table class="table table-bordered">
        ...
        $ret=mysqli_query($con,"SELECT * FROM tblambulancehiring WHERE DriverID='$driverid' AND Status='Pickup'");
        $cnt=1;
        ...
        <tbody>
          <tr data-expanded="true">
            ...
            <td>
              ...
              <a href="update-request-status.php?id=<?php echo $row['ID'];?>&status=reached" class="btn btn-success">Mark Completed</a>
            </td>
          </tr>
          <?php 
          $cnt=$cnt+1;
