...
?>
                            <div class="col-md-8 market-update-left">
                                <h4><a href="all-amublance-request.php" style="color: white">All Ambulance Request</a>
                                </h4>
...
?>
                            <div class="col-md-8 market-update-left">
                                <a href="assign-ambulance-request.php">
                                    <h4>Assigned Request</h4>
                                </a>
...
?>
                            <div class="col-md-8 market-update-left">
                                <a href="ontheway-ambulance-request.php">
                                    <h4>On The Way Ambulance </h4>
                                </a>
...
?>
                            <div class="col-md-8 market-update-left">
                                <a href="pickup-ambulance-request.php">
                                    <h4>Patient Picked </h4>
                                </a>
...
?>
                            <div class="col-md-8 market-update-left">
                                <a href="reached-ambulance-request.php">
                                    <h4>Patient Reached </h4>
                                </a>
...
?>
                    <div class="col-md-4 market-update-gd" style="margin-top:1%;">
                        <div class="market-update-block clr-block-2">
                            ...
                            <div class="col-md-8 market-update-left">
                                <a href="rejected-ambulance-request.php">
